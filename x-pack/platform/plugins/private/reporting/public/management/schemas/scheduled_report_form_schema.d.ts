...
export declare const getScheduledReportFormSchema: (validateEmailAddresses: ActionsPublicPluginSetup["validateEmailAddresses"], availableReportTypes?: ReportTypeData[]) => {
    title: {
        ...
        label: string;
        validations: {
            validator: (data: import("@kbn/es-ui-shared-plugin/static/forms/hook_form_lib").ValidationFuncArg<import("@kbn/es-ui-shared-plugin/static/forms/hook_form_lib").FormData, unknown>) => ReturnType<import("@kbn/es-ui-shared-plugin/static/forms/hook_form_lib").ValidationFunc<any, import("@kbn/osquery-plugin/public/shared_imports").ERROR_CODE>>;
        }[];
    };
    reportTypeId: {
        type: string;
