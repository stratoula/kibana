export declare const updateScheduledReportParamsSchema: import("@kbn/config-schema").ObjectType<{
    id: import("@kbn/config-schema").Type<string>;
}>;
export declare const updateScheduledReportBodySchema: import("@kbn/config-schema").ObjectType<{
