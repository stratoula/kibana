...
import type { Agent, AgentAction, ActionStatus, CurrentUpgrade, NewAgentAction, AgentDiagnostics, AgentStatus } from '../models';
...
export declare enum RequestDiagnosticsAdditionalMetrics {
    'CPU' = "CPU"
}
