...
import type { AssetReference, CategorySummaryList, PackageList, PackageInfo, PackageUsageStats, InstallType, InstallSource, EpmPackageInstallStatus, SimpleSOAssetType, AssetSOObject, InstallResultStatus, PackageMetadata, InstallationInfo } from '../models/epm';
...
export type GetInputsTemplatesResponse = string | {
    inputs: any;
};
...
export declare const RollbackAvailableCheckResponseSchema: import("@kbn/config-schema").ObjectType<{
    reason: import("@kbn/config-schema").Type<string | undefined>;
    isAvailable: import("@kbn/config-schema").Type<boolean>;
}>;
export type RollbackAvailableCheckResponse = TypeOf<typeof RollbackAvailableCheckResponseSchema>;
export declare const BulkRollbackAvailableCheckResponseSchema: import("@kbn/config-schema").Type<Record<string, Readonly<{
    reason?: string | undefined;
} & {
    isAvailable: boolean;
}>>>;
export type BulkRollbackAvailableCheckResponse = TypeOf<typeof BulkRollbackAvailableCheckResponseSchema>;
