...
export declare function comparePreconfiguredPolicyToCurrent(policyFromConfig: PreconfiguredAgentPolicy, currentPolicy: AgentPolicy): {
    hasChanged: boolean;
    fields: Pick<PreconfiguredAgentPolicy, "name" | "description" | "overrides" | "agentless" | "is_managed" | "supports_agentless" | "space_ids" | "is_default" | "is_default_fleet_server" | "has_fleet_server" | "monitoring_enabled" | "unenroll_timeout" | "inactivity_timeout" | "is_preconfigured" | "data_output_id" | "monitoring_output_id" | "download_source_id" | "fleet_server_host_id" | "schema_version" | "agent_features" | "is_protected" | "advanced_settings" | "keep_monitoring_alive" | "global_data_tags" | "monitoring_pprof_enabled" | "monitoring_http" | "monitoring_diagnostics" | "required_versions" | "has_agent_version_conditions" | "is_verifier">;
};
export {};
