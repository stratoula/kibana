...
export declare const AgentComponentStateSchema: import("@kbn/config-schema").Type<"HEALTHY" | "STARTING" | "CONFIGURING" | "DEGRADED" | "FAILED" | "STOPPING" | "STOPPED">;
...
export declare const AgentStatusSchema: import("@kbn/config-schema").Type<"error" | "offline" | "online" | "inactive" | "enrolling" | "unenrolling" | "unenrolled" | "updating" | "degraded" | "uninstalled" | "orphaned">;
export declare const AgentResponseSchema: import("@kbn/config-schema").ObjectType<{
    ...
    status: import("@kbn/config-schema").Type<"error" | "offline" | "online" | "inactive" | "enrolling" | "unenrolling" | "unenrolled" | "updating" | "degraded" | "uninstalled" | "orphaned" | undefined>;
    last_known_status: import("@kbn/config-schema").Type<"error" | "offline" | "online" | "inactive" | "enrolling" | "unenrolling" | "unenrolled" | "updating" | "degraded" | "uninstalled" | "orphaned" | undefined>;
    ...
    last_checkin_status: import("@kbn/config-schema").Type<"error" | "online" | "updating" | "degraded" | "starting" | undefined>;
    ...
    components: import("@kbn/config-schema").Type<Readonly<{
        units?: Readonly<{
            ...
            message: string;
            id: string;
            status: "HEALTHY" | "STARTING" | "CONFIGURING" | "DEGRADED" | "FAILED" | "STOPPING" | "STOPPED";
        }>[] | undefined;
    } & {
        type: string;
        message: string;
    ...
    unhealthy_reason: import("@kbn/config-schema").Type<("input" | "output" | "other")[] | null | undefined>;
...
export declare const GetAgentsResponseSchema: import("@kbn/config-schema").ObjectType<Omit<{
    ...
    statusSummary: import("@kbn/config-schema").Type<Record<"error" | "offline" | "online" | "inactive" | "enrolling" | "unenrolling" | "unenrolled" | "updating" | "degraded" | "uninstalled" | "orphaned", number> | undefined>;
}>;
...
export declare const PostNewAgentActionRequestSchema: {
    body: import("@kbn/config-schema").ObjectType<{
        action: import("@kbn/config-schema").Type<Readonly<{
            ...
            type: "SETTINGS";
            data: Readonly<{} & {
                log_level: "error" | "info" | "warning" | "debug" | null;
            }>;
        }>>;
    }>;
    params: import("@kbn/config-schema").ObjectType<{
...
export declare const ListAgentUploadsResponseSchema: import("@kbn/config-schema").ObjectType<{
    items: import("@kbn/config-schema").Type<Readonly<{
        ...
        name: string;
        id: string;
        status: "FAILED" | "EXPIRED" | "IN_PROGRESS" | "READY" | "AWAITING_UPLOAD" | "DELETED";
        actionId: string;
        filePath: string;
        createTime: string;
    }>[]>;
...
export declare const GetActionStatusResponseSchema: import("@kbn/config-schema").ObjectType<{
    items: import("@kbn/config-schema").Type<Readonly<{
        ...
        type: "UNENROLL" | "UPGRADE" | "ROLLBACK" | "SETTINGS" | "POLICY_REASSIGN" | "CANCEL" | "FORCE_UNENROLL" | "UPDATE_TAGS" | "REQUEST_DIAGNOSTICS" | "POLICY_CHANGE" | "INPUT_ACTION" | "MIGRATE" | "PRIVILEGE_LEVEL_CHANGE";
        status: "FAILED" | "COMPLETE" | "EXPIRED" | "CANCELLED" | "IN_PROGRESS" | "ROLLOUT_PASSED";
        actionId: string;
