...
export declare const ruleLastRunSchema: import("@kbn/config-schema").ObjectType<{
    ...
    warning: import("@kbn/config-schema").Type<"disabled" | "execute" | "unknown" | "validate" | "license" | "timeout" | "read" | "decrypt" | "maxExecutableActions" | "maxAlerts" | "maxQueuedActions" | "ruleExecution" | null | undefined>;
...
export declare const snoozeScheduleSchema: import("@kbn/config-schema").ObjectType<{
    ...
    rRule: import("@kbn/config-schema").ObjectType<{
        ...
        freq: import("@kbn/config-schema").Type<0 | 1 | 3 | 2 | 5 | 4 | 6 | undefined>;
