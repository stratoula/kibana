...
export type ConstructorOptions = Omit<RulesClientContext, 'fieldsToExcludeFromPublicApi' | 'minimumScheduleIntervalInMs'>;
export declare const fieldsToExcludeFromPublicApi: Array<keyof SanitizedRule>;
...
export declare class RulesClient {
    ...
    clone: <Params extends RuleTypeParams = never>(params: CloneRuleParams) => Promise<SanitizedRule<Params>>;
    create: <Params extends RuleTypeParams = never>(params: CreateRuleParams<Params>) => Promise<SanitizedRule<Params>>;
    ...
    get: <Params extends RuleTypeParams = never>(params: GetRuleParams) => Promise<SanitizedRule<Params> | import("../types").SanitizedRuleWithLegacyId<Params>>;
    ...
    update: <Params extends RuleTypeParams = never>(params: UpdateRuleParams<Params>) => Promise<SanitizedRule<Params>>;
    ...
    bulkDeleteRules: (options: BulkDeleteRulesRequestBody) => Promise<import("../application/rule/methods/bulk_delete").BulkDeleteRulesResult<Record<string, any>>>;
    ...
    snooze: (options: SnoozeRuleOptions) => Promise<SanitizedRule<never>>;
