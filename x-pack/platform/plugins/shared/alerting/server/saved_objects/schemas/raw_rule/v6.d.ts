export declare const rawRuleInvestigationGuideSchema: import("@kbn/config-schema").ObjectType<{
    blob: import("@kbn/config-schema").Type<string>;
}>;
export declare const artifactsSchema: import("@kbn/config-schema").ObjectType<Omit<{
...
export declare const rawRuleSchema: import("@kbn/config-schema").ObjectType<Omit<Omit<Omit<{
