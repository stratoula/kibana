...
export declare const getMigrations7160: (encryptedSavedObjects: EncryptedSavedObjectsPluginSetup, isPreconfigured: (connectorId: string) => boolean) => (doc: SavedObjectUnsanitizedDoc<{
    meta?: Readonly<{
