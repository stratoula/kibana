...
type AlertMigration = (doc: SavedObjectUnsanitizedDoc<RawRule>, context: SavedObjectMigrationContext) => SavedObjectUnsanitizedDoc<RawRule>;
export declare function createEsoMigration(encryptedSavedObjects: EncryptedSavedObjectsPluginSetup, isMigrationNeededPredicate: IsMigrationNeededPredicate<RawRule, RawRule>, migrationFunc: AlertMigration): (doc: SavedObjectUnsanitizedDoc<{
    meta?: Readonly<{
...
export declare function pipeMigrations(...migrations: AlertMigration[]): AlertMigration;
export declare const isSiemSignalsRuleType: (doc: SavedObjectUnsanitizedDoc<RawRule>) => boolean;
export declare const isEsQueryRuleType: (doc: SavedObjectUnsanitizedDoc<RawRule>) => boolean;
export declare const isDetectionEngineAADRuleType: (doc: SavedObjectUnsanitizedDoc<RawRule>) => boolean;
/**
 ...
 */
export declare const isSecuritySolutionLegacyNotification: (doc: SavedObjectUnsanitizedDoc<RawRule>) => boolean;
export declare const isLogThresholdRuleType: (doc: SavedObjectUnsanitizedDoc<RawRule>) => boolean;
export {};
