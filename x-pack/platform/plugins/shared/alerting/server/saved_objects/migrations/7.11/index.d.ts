...
export declare const isAnyActionSupportIncidents: (doc: SavedObjectUnsanitizedDoc<RawRule>) => boolean;
export declare const getMigrations7110: (encryptedSavedObjects: EncryptedSavedObjectsPluginSetup) => (doc: SavedObjectUnsanitizedDoc<{
    meta?: Readonly<{
...
export declare const getMigrations7112: (encryptedSavedObjects: EncryptedSavedObjectsPluginSetup) => (doc: SavedObjectUnsanitizedDoc<{
    meta?: Readonly<{
        versionApiKeyLastmodified?: string | undefined;
    } & {}> | undefined;
    running?: boolean | null | undefined;
