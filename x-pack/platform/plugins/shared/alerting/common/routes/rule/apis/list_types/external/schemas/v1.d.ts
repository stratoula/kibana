...
export declare const typesRulesSchema: import("@kbn/config-schema").ObjectType<{
    ...
    minimum_license_required: import("@kbn/config-schema").Type<"gold" | "basic" | "standard" | "platinum" | "enterprise" | "trial">;
    name: import("@kbn/config-schema").Type<string>;
...
export declare const typesRulesResponseBodySchema: import("@kbn/config-schema").Type<Readonly<{
    ...
    name: string;
    producer: string;
    minimum_license_required: "gold" | "basic" | "standard" | "platinum" | "enterprise" | "trial";
