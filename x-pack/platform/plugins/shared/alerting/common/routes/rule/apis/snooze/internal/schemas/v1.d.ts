export declare const snoozeParamsInternalSchema: import("@kbn/config-schema").ObjectType<{
    id: import("@kbn/config-schema").Type<string>;
}>;
export declare const snoozeBodyInternalSchema: import("@kbn/config-schema").ObjectType<{
    snooze_schedule: import("@kbn/config-schema").ObjectType<{
