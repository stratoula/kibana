...
export declare const LibraryPanel: <T extends LibraryItem>({ onClose, allItems, activeItemIdSet, onToggleItem, mutatingItemId, flyoutTitleId, libraryLabels, manageLibraryPath, getItemName, getSearchableText, disabledItemIdSet, readOnlyItemIdSet, callout, }: LibraryPanelProps<T>) => React.JSX.Element;
