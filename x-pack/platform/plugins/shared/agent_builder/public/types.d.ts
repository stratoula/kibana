...
import type { AgentsServiceStartContract, AttachmentServiceStartContract, EventsServiceStartContract, ToolServiceStartContract } from '@kbn/agent-builder-browser';
...
export interface AgentBuilderPluginStart {
     ...
     * ```
     */
    updateAttachmentOrigin: (conversationId: string, attachmentId: string, origin: string) => Promise<UpdateOriginResponse>;
}
