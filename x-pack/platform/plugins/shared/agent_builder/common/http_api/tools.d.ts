...
export declare const TOOL_USED_BY_AGENTS_ERROR_CODE = "TOOL_USED_BY_AGENTS";
export interface AgentRef {
    id: string;
    name: string;
}
export type CreateToolPayload = Omit<ToolDefinition, 'description' | 'tags' | 'readonly'> & Partial<Pick<ToolDefinition, 'description' | 'tags'>>;
...
export type BulkCreateMcpToolResult = BulkCreateMcpToolSuccessResult | BulkCreateMcpToolSkippedResult | BulkCreateMcpToolFailureResult;
...
export declare const OAUTH_STATUS: {
...
export declare const isMcpConnectorItem: (connector: ConnectorItem) => connector is McpConnectorItem;
...
export type BulkDeleteConnectorResult = BulkDeleteConnectorSuccessResult | BulkDeleteConnectorFailureResult;
...
export type McpToolHealthStatus = 'healthy' | 'tool_not_found' | 'connector_not_found' | 'list_tools_failed' | 'tool_unhealthy';
