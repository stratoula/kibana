...
import type { CaseUI, CaseConnectors, UserActionUI, AttachmentUIV2, UseFetchAlertData, CaseUserActionsStats, CasesConfigurationUI } from '../../containers/types';
...
export type SupportedUserActionTypes = keyof Omit<typeof UserActionTypes, UnsupportedUserActionTypes>;
