...
import type { EventAttachmentPayload, ExternalReferenceAttachmentPayload, PersistableStateAttachmentPayload, UnifiedAttachmentPayload, UserCommentAttachmentPayload } from '../../types/domain';
/**
