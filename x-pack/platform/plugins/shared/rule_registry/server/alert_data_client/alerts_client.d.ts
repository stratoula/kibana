...
export declare class AlertsClient {
    ...
    bulkUpdate<Params extends RuleTypeParams = never>({ ids, query, index, status, }: BulkUpdateOptions<Params>): Promise<estypes.BulkResponse | estypes.UpdateByQueryResponse>;
