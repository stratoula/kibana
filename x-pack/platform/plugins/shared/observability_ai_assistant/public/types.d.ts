...
import type { ChatCompletionChunkEvent, MessageAddEvent, StreamingChatResponseEventWithoutError } from '../common/conversation_complete';
import type { FunctionDefinition, FunctionResponse } from '../common/functions/types';
import type { Message, ObservabilityAIAssistantScreenContext, PendingMessage, Instruction } from '../common/types';
...
export interface ObservabilityAIAssistantChatService {
    ...
    renderFunction: (name: string, args: string | undefined, response: {
        data?: string;
        content?: string;
    }, onActionClick: ChatActionClickHandler) => React.ReactNode;
...
export type RegisterRenderFunctionDefinition<TFunctionArguments = any, TFunctionResponse extends FunctionResponse = any> = (name: string, render: RenderFunction<TFunctionArguments, TFunctionResponse>) => void;
