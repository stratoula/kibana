...
export declare const findFieldsMetadataRequestQueryRT: rt.Type<{
    attributes?: ("normalize" | "name" | "type" | "level" | "description" | "source" | "index" | "short" | "format" | "required" | "doc_values" | "pattern" | "beta" | "example" | "otel" | "flat_name" | "allowed_values" | "dashed_name" | "expected_values" | "ignore_above" | "input_format" | "multi_fields" | "object_type" | "original_fieldset" | "output_format" | "output_precision" | "scaling_factor" | "documentation_url" | "otel_equivalent")[] | undefined;
    fieldNames?: string[] | undefined;
    source?: "ecs" | "streams" | "unknown" | "metadata" | "integration" | "otel" | ("ecs" | "streams" | "unknown" | "metadata" | "integration" | "otel")[] | undefined;
