 ...
 */
export declare const getForFeature: (registry: InferenceFeatureRegistry, soClient: ISavedObjectsRepository, getConnectorById: (id: string) => Promise<InferenceConnector>, featureId: string, logger: Logger) => Promise<ResolvedInferenceEndpoints>;
