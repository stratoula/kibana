 ...
 **/
export declare function deserializeState({ attributeService, ...services }: Pick<LensEmbeddableStartServices, 'attributeService'> & ESQLStartServices, state: LensSerializedAPIConfig): Promise<LensRuntimeState>;
...
export declare function transformFromApiConfig(rawState: LensSerializedAPIConfig | FlattenedLensByValuePanelSchema): LensSerializedState;
/**
