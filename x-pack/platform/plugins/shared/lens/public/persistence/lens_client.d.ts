...
import type { LensCreateRequestQuery, LensItemMeta, LensUpdateRequestQuery } from '../../server/api/routes/types';
...
export declare class LensClient {
    ...
    create({ description, visualizationType, state, title, version }: LooseLensAttributes, references: Reference[], options?: LensCreateRequestQuery): Promise<LensItemResponse>;
