...
import type { VisualizeFieldContext, ACTION_VISUALIZE_LENS_FIELD } from '@kbn/ui-actions-plugin/public';
...
import type { LensAppLocatorParams, LensSerializedState, UserMessagesGetter, LensStartServices as StartServices, EditorFrameInstance, VisualizeEditorContext, LensTopNavMenuEntryGenerator, LensDocument, LensInspector } from '@kbn/lens-common';
...
export type RunSave = (saveProps: Omit<OnSaveProps, 'onTitleDuplicate' | 'newDescription'> & {
...
type AvailableTopNavActions = 'inspect' | 'saveAndReturn' | 'showSaveModal' | 'goBack' | 'cancel' | 'share' | 'export' | 'getUnderlyingDataUrl' | 'openSettings';
