...
export declare const SaveModal: ({ domElement, savedObjectsTagging, onSave, title, description, tags, showCopyOnSave, }: {
...
/** @internal exported for testing only */
export declare const onSave: ({ state, layer, setState, registerLibraryAnnotationGroup, eventAnnotationService, toasts, modalOnSaveProps: { newTitle, newDescription, newTags, closeModal, newCopyOnSave, onTitleDuplicate, isTitleDuplicateConfirmed, }, dataViews, goToAnnotationLibrary, startServices, }: {
