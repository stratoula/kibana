...
export declare const getAnnotationsAccessorColorConfig: (layer: XYAnnotationLayerConfig) => import("@kbn/visualization-ui-components").AccessorConfig[];
export declare const getAnnotationsConfiguration: ({ state, frame, layer, }: {
