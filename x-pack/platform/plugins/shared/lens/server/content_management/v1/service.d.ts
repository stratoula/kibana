        ...
        out: {
            result: {
                ...
                up: (result: LensGetOut) => {
                    item: import("../../../common/content_management/v1/transforms").LensSavedObjectV1;
                    meta: {
    ...
    search: {
        ...
        out: {
            result: {
                ...
                up: (item: LensSavedObject) => import("../../../common/content_management/v1/transforms").LensSavedObjectV1;
            };
        };
    };
};
