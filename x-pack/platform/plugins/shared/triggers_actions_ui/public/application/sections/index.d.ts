...
export declare const RulesListNotifyBadgeWithApi: (props: Pick<import("./rules_list/components/notify_badge/types").RulesListNotifyBadgeProps, "disabled" | "showOnHover" | "loading" | "snoozeSettings" | "onRuleChanged" | "showTooltipInline"> & {
    ruleId: string;
