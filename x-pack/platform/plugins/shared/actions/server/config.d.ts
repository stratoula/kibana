...
export declare const configSchema: import("@kbn/config-schema").ObjectType<{
    ...
    ssl: import("@kbn/config-schema").Type<Readonly<{
        verificationMode?: "none" | "certificate" | "full" | undefined;
        proxyVerificationMode?: "none" | "certificate" | "full" | undefined;
    } & {}> | undefined>;
    ...
    email: import("@kbn/config-schema").Type<Readonly<{
        ...
        services?: Readonly<{
            enabled?: ("*" | "google-mail" | "microsoft-exchange" | "microsoft-outlook" | "amazon-ses" | "elastic-cloud" | "other")[] | undefined;
            ses?: Readonly<{} & {
                host: string;
                port: number;
            }> | undefined;
