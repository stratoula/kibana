...
export declare class TaskManagerRunner implements TaskRunner {
     ...
     */
    constructor({ basePathService, instance, definitions, logger, store, beforeRun, beforeMarkRunning, defaultMaxAttempts, onTaskEvent, executionContext, usageCounter, config, allowReadingInvalidState, strategy, getPollInterval, eventLogger, }: Opts);
    /**
