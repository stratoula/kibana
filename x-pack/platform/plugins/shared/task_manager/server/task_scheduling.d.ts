...
import type { ApiKeyOptions, ConcreteTaskInstance, IntervalSchedule, RruleSchedule, ScheduleOptions, TaskInstanceWithDeprecatedFields, TaskInstanceWithId } from './task';
...
export declare class TaskScheduling {
     ...
     */
    schedule(taskInstance: TaskInstanceWithDeprecatedFields, options?: ScheduleOptions): Promise<ConcreteTaskInstance>;
    /**
     ...
     * @returns {Promise<ConcreteTaskInstance>}
     */
    bulkSchedule(taskInstances: TaskInstanceWithDeprecatedFields[], options?: ScheduleOptions): Promise<ConcreteTaskInstance[]>;
    bulkDisable(taskIds: string[], clearStateIdsOrBoolean?: string[] | boolean, options?: ApiKeyOptions): Promise<BulkUpdateTaskResult>;
    bulkEnable(taskIds: string[], runSoon?: boolean, options?: ApiKeyOptions): Promise<BulkUpdateTaskResult>;
    bulkUpdateState(taskIds: string[], stateMapFn: (s: ConcreteTaskInstance['state'], id: string) => ConcreteTaskInstance['state'], options?: ApiKeyOptions): Promise<BulkUpdateTaskResult>;
    /**
     ...
     */
    bulkUpdateSchedules(taskIds: string[], schedule: IntervalSchedule | RruleSchedule, options?: ApiKeyOptions): Promise<BulkUpdateTaskResult>;
     ...
     */
    ensureScheduled(taskInstance: TaskInstanceWithId, options?: ScheduleOptions): Promise<TaskInstanceWithId>;
}
