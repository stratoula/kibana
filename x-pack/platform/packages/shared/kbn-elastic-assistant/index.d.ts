...
export { AssistantSpaceIdProvider, useAssistantLastConversation, } from './impl/assistant/use_space_aware_context';
/**
...
ATTACK_DISCOVERY_STORAGE_KEY, DEFAULT_ASSISTANT_NAMESPACE, 
/** The default maximum number of alerts to be sent as context when generating Attack discoveries */
DEFAULT_ATTACK_DISCOVERY_MAX_ALERTS, DEFAULT_LATEST_ALERTS, DEFEND_INSIGHTS_STORAGE_KEY, 
...
FILTERS_LOCAL_STORAGE_KEY, KNOWLEDGE_BASE_LOCAL_STORAGE_KEY, 
...
MOVING_ATTACKS_CALLOUT_LOCAL_STORAGE_KEY, } from './impl/assistant_context/constants';
...
QueryType, } from './impl/assistant/use_conversation/helpers';
export type { 
...
GetAssistantMessages, } from './impl/assistant_context/types';
/**
...
type SingleRangeChangeEvent, } from './impl/knowledge_base/alerts_range';
export { 
/** A label instructing the user to send fewer alerts */
SELECT_FEWER_ALERTS, 
/** Your anonymization settings will apply to these alerts (label) */
YOUR_ANONYMIZATION_SETTINGS, } from './impl/knowledge_base/translations';
