 ...
 */
export type ChatAgentEvent = ToolCallEvent | BrowserToolCallEvent | ToolProgressEvent | ToolUiEvent | ToolResultEvent | PromptRequestEvent | ReasoningEvent | MessageChunkEvent | MessageCompleteEvent | ThinkingCompleteEvent | RoundCompleteEvent | CompactionStartedEvent | CompactionCompletedEvent;
/**
