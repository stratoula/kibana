 ...
 */
export declare const agentBuilderDefaultAgentId = "elastic-ai-agent";
/**
 ...
 */
export type RuntimeAgentConfigurationOverrides = Pick<AgentConfigurationOverrides, 'instructions' | 'tools'>;
