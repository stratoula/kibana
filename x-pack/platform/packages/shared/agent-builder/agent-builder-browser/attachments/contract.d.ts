...
import type { UnknownAttachment, AttachmentVersion, UpdateOriginResponse, ScreenContextAttachmentData } from '@kbn/agent-builder-common/attachments';
 ...
 */
export interface AttachmentLifecycleParams<TAttachment extends UnknownAttachment = UnknownAttachment> {
