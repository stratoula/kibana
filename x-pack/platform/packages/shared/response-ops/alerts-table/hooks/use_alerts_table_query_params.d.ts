...
export interface UseAlertsTableQueryParamsOptions extends SetRequired<Pick<AlertsTableProps, 'ruleTypeIds' | 'consumers' | 'query' | 'sort' | 'runtimeMappings' | 'pageIndex' | 'pageSize' | 'minScore' | 'trackScores'>, 'sort'> {
    fields: Array<{
        field: string;
 ...
 */
export declare const useAlertsTableQueryParams: ({ ruleTypeIds, consumers, fields, query, sort, runtimeMappings, pageIndex, pageSize, minScore, trackScores, dispatchBulkAction, setPageIndex, }: UseAlertsTableQueryParamsOptions) => {
    ruleTypeIds: string[];
