...
export declare const RuleActionsNotifyWhen: ({ hasAlertsMappings, frequency, throttle, throttleUnit, showMinimumThrottleWarning, showMinimumThrottleUnitWarning, notifyWhenSelectOptions, onChange, onUseDefaultMessage, }: RuleActionsNotifyWhenProps) => React.JSX.Element;
