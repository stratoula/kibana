 ...
 */
export type ContentListAction = SetQueryAction | ResetQueryAction | SetSortAction | {
    type: typeof CONTENT_LIST_ACTIONS.SET_PAGE_INDEX;
    payload: {
        index: number;
    };
} | {
    type: typeof CONTENT_LIST_ACTIONS.SET_PAGE_SIZE;
    payload: {
        size: number;
    };
} | {
    type: typeof CONTENT_LIST_ACTIONS.SET_SELECTION;
    payload: {
        ids: string[];
    };
} | {
