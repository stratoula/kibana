...
export declare const AS_CODE_DATA_VIEW_REFERENCE_TYPE: "data_view_reference";
/** `type` discriminator for as-code `data_source`: inline DataViewSpec-shaped fields. */
export declare const AS_CODE_DATA_VIEW_SPEC_TYPE: "data_view_spec";
/** `type` discriminator for as-code `data_source`: ES|QL query. */
export declare const AS_CODE_ESQL_DATA_SOURCE_TYPE: "esql";
