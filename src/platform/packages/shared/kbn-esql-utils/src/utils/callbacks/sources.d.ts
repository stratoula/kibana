 ...
 * @returns A promise that resolves to an array of ESQLSourceResult objects.
 */
export declare const getESQLSources: (core: Pick<CoreStart, "application" | "http">, getLicense: (() => Promise<ILicense | undefined>) | undefined, signal?: AbortSignal, projectRouting?: string) => Promise<ESQLSourceResult[]>;
