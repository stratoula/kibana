 ...
 */
export declare const useDocViewerViewedEvent: ({ reportEvent, contentId, tabId, keys, enabled, initialEventKey, onEventKeyChange, skipNextReport, }: UseDocViewerViewedEventParams) => void;
/**
