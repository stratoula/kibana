...
export declare const horizontalAlignmentSchema: (opts?: Options<HorizontalAlignment>) => import("@kbn/config-schema").Type<"center" | "left" | "right">;
...
export declare const positionSchema: (opts?: Options<Position>) => import("@kbn/config-schema").Type<"top" | "bottom" | "left" | "right">;
...
export declare const placementSchema: (opts?: Options<BeforeAfterAlignment>) => import("@kbn/config-schema").Type<"after" | "before">;
export {};
