 ...
 */
export declare const waffleStateSharedSchema: {
 ...
 */
export declare const waffleStateSchemaNoESQL: import("@kbn/config-schema").ObjectType<{
 ...
 */
export declare const waffleStateSchemaESQL: import("@kbn/config-schema").ObjectType<{
    metrics: import("@kbn/config-schema").Type<Readonly<{
        format?: Readonly<{
            suffix?: string | undefined;
        } & {
 ...
 */
export declare const waffleStateSchema: import("./utils/object_union").ObjectUnionType<[import("@kbn/config-schema").ObjectType<{
    metrics: import("@kbn/config-schema").Type<(Readonly<{
        filter?: Readonly<{} & {
            expression: string;
            language: "kql" | "lucene";
