...
export declare const heatmapStateSchemaNoESQL: import("@kbn/config-schema").ObjectType<{
    ...
    axes: import("@kbn/config-schema").Type<Readonly<{
        x?: Readonly<{
...
export declare const heatmapStateSchema: import("./utils/object_union").ObjectUnionType<[import("@kbn/config-schema").ObjectType<{
    metric: import("@kbn/config-schema").Type<Readonly<{
        filter?: Readonly<{} & {
            expression: string;
            language: "kql" | "lucene";
