...
export declare const legendVisibilitySchemaWithAuto: import("@kbn/config-schema").Type<"hidden" | "auto" | "visible" | undefined>;
export declare const legendSizeSchema: import("@kbn/config-schema").Type<"m" | "s" | "l" | "auto" | "xl" | undefined>;
/**
 ...
 * - bucket operations
 */
export declare function mergeAllMetricsWithChartDimensionSchema<T extends Props>(baseSchema: T): import("@kbn/config-schema").Type<Readonly<{ [K_1 in keyof ((Omit<Omit<Omit<Omit<Omit<{
    ...
    time_scale: import("@kbn/config-schema").Type<"m" | "s" | "h" | "d" | undefined>;
    reduced_time_range: import("@kbn/config-schema").Type<string | undefined>;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_59 extends keyof T ? { [P_1 in T_59]: T[P_1]; } : never)]: T[K]; } extends infer T_58 extends Props ? { [Key_15 in keyof T_58]: undefined extends TypeOf<T_58[Key_15]> ? Key_15 : never; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filter", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"formula", keyof T> | Exclude<"time_scale", keyof T> | Exclude<"reduced_time_range", keyof T>] extends infer T_57 extends keyof (Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
    ...
    time_scale: import("@kbn/config-schema").Type<"m" | "s" | "h" | "d" | undefined>;
    reduced_time_range: import("@kbn/config-schema").Type<string | undefined>;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_63 extends keyof T ? { [P_1 in T_63]: T[P_1]; } : never)]: T[K]; } extends infer T_62 extends Props ? { [Key_16 in keyof T_62]: undefined extends TypeOf<T_62[Key_16]> ? never : Key_16; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filter", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"formula", keyof T> | Exclude<"time_scale", keyof T> | Exclude<"reduced_time_range", keyof T>] extends infer T_61 extends keyof (Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
...
export declare function mergeAllMetricsWithChartDimensionSchemaWithRefBasedOps<T extends Props>(baseSchema: T): import("@kbn/config-schema").Type<Readonly<{ [K_1 in keyof ((Omit<Omit<Omit<Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
    ...
    time_scale: import("@kbn/config-schema").Type<"m" | "s" | "h" | "d" | undefined>;
    reduced_time_range: import("@kbn/config-schema").Type<string | undefined>;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_91 extends keyof T ? { [P_1 in T_91]: T[P_1]; } : never)]: T[K]; } extends infer T_90 extends Props ? { [Key_23 in keyof T_90]: undefined extends TypeOf<T_90[Key_23]> ? Key_23 : never; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filter", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"formula", keyof T> | Exclude<"time_scale", keyof T> | Exclude<"reduced_time_range", keyof T>] extends infer T_89 extends keyof (Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
    ...
    time_scale: import("@kbn/config-schema").Type<"m" | "s" | "h" | "d" | undefined>;
    reduced_time_range: import("@kbn/config-schema").Type<string | undefined>;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_95 extends keyof T ? { [P_1 in T_95]: T[P_1]; } : never)]: T[K]; } extends infer T_94 extends Props ? { [Key_24 in keyof T_94]: undefined extends TypeOf<T_94[Key_24]> ? never : Key_24; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filter", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"formula", keyof T> | Exclude<"time_scale", keyof T> | Exclude<"reduced_time_range", keyof T>] extends infer T_93 extends keyof (Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
...
export declare function mergeAllMetricsWithChartDimensionSchemaWithTimeBasedAndStaticOps<T extends Props>(baseSchema: T): import("@kbn/config-schema").Type<Readonly<{ [K_1 in keyof ((Omit<Omit<Omit<Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
    ...
    time_scale: import("@kbn/config-schema").Type<"m" | "s" | "h" | "d" | undefined>;
    reduced_time_range: import("@kbn/config-schema").Type<string | undefined>;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_99 extends keyof T ? { [P_1 in T_99]: T[P_1]; } : never)]: T[K]; } extends infer T_98 extends Props ? { [Key_25 in keyof T_98]: undefined extends TypeOf<T_98[Key_25]> ? Key_25 : never; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filter", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"formula", keyof T> | Exclude<"time_scale", keyof T> | Exclude<"reduced_time_range", keyof T>] extends infer T_97 extends keyof (Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
    ...
    time_scale: import("@kbn/config-schema").Type<"m" | "s" | "h" | "d" | undefined>;
    reduced_time_range: import("@kbn/config-schema").Type<string | undefined>;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_103 extends keyof T ? { [P_1 in T_103]: T[P_1]; } : never)]: T[K]; } extends infer T_102 extends Props ? { [Key_26 in keyof T_102]: undefined extends TypeOf<T_102[Key_26]> ? never : Key_26; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filter", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"formula", keyof T> | Exclude<"time_scale", keyof T> | Exclude<"reduced_time_range", keyof T>] extends infer T_101 extends keyof (Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
...
export declare function mergeAllMetricsWithChartDimensionSchemaWithStaticOps<T extends Props>(baseSchema: T): import("@kbn/config-schema").Type<Readonly<{ [K_1 in keyof ((Omit<Omit<Omit<Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
    ...
    time_scale: import("@kbn/config-schema").Type<"m" | "s" | "h" | "d" | undefined>;
    reduced_time_range: import("@kbn/config-schema").Type<string | undefined>;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_67 extends keyof T ? { [P_1 in T_67]: T[P_1]; } : never)]: T[K]; } extends infer T_66 extends Props ? { [Key_17 in keyof T_66]: undefined extends TypeOf<T_66[Key_17]> ? Key_17 : never; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filter", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"formula", keyof T> | Exclude<"time_scale", keyof T> | Exclude<"reduced_time_range", keyof T>] extends infer T_65 extends keyof (Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
    ...
    time_scale: import("@kbn/config-schema").Type<"m" | "s" | "h" | "d" | undefined>;
    reduced_time_range: import("@kbn/config-schema").Type<string | undefined>;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_71 extends keyof T ? { [P_1 in T_71]: T[P_1]; } : never)]: T[K]; } extends infer T_70 extends Props ? { [Key_18 in keyof T_70]: undefined extends TypeOf<T_70[Key_18]> ? never : Key_18; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filter", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"formula", keyof T> | Exclude<"time_scale", keyof T> | Exclude<"reduced_time_range", keyof T>] extends infer T_69 extends keyof (Omit<Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    format: import("@kbn/config-schema").Type<Readonly<{
        suffix?: string | undefined;
    } & {
...
export declare function mergeAllBucketsWithChartDimensionSchema<T extends Props>(baseSchema: T): import("@kbn/config-schema").Type<Readonly<{ [K_1 in keyof ((Omit<{
    field: import("@kbn/config-schema").Type<string>;
...
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_11 extends keyof T ? { [P_1 in T_11]: T[P_1]; } : never)]: T[K]; } extends infer T_10 extends Props ? { [Key_3 in keyof T_10]: undefined extends TypeOf<T_10[Key_3]> ? Key_3 : never; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"includes", keyof T> | Exclude<"limit", keyof T> | Exclude<"format", keyof T> | Exclude<"fields", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"increase_accuracy", keyof T> | Exclude<"excludes", keyof T> | Exclude<"other_bucket", keyof T> | Exclude<"rank_by", keyof T>] extends infer T_9 extends keyof (Omit<{
    fields: import("@kbn/config-schema").Type<string[]>;
    limit: import("@kbn/config-schema").Type<number>;
    increase_accuracy: import("@kbn/config-schema").Type<boolean | undefined>;
    includes: import("@kbn/config-schema").Type<Readonly<{
    ...
    operation: import("@kbn/config-schema").Type<"terms">;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_15 extends keyof T ? { [P_1 in T_15]: T[P_1]; } : never)]: T[K]; } extends infer T_14 extends Props ? { [Key_4 in keyof T_14]: undefined extends TypeOf<T_14[Key_4]> ? never : Key_4; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"includes", keyof T> | Exclude<"limit", keyof T> | Exclude<"format", keyof T> | Exclude<"fields", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"increase_accuracy", keyof T> | Exclude<"excludes", keyof T> | Exclude<"other_bucket", keyof T> | Exclude<"rank_by", keyof T>] extends infer T_13 extends keyof (Omit<{
    fields: import("@kbn/config-schema").Type<string[]>;
    limit: import("@kbn/config-schema").Type<number>;
    increase_accuracy: import("@kbn/config-schema").Type<boolean | undefined>;
    includes: import("@kbn/config-schema").Type<Readonly<{
...
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_19 extends keyof T ? { [P_1 in T_19]: T[P_1]; } : never)]: T[K]; } extends infer T_18 extends Props ? { [Key_5 in keyof T_18]: undefined extends TypeOf<T_18[Key_5]> ? Key_5 : never; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"field", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"include_empty_rows", keyof T> | Exclude<"granularity", keyof T>] extends infer T_17 extends keyof (Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    field: import("@kbn/config-schema").Type<string>;
    granularity: import("@kbn/config-schema").Type<number | "auto">;
    include_empty_rows: import("@kbn/config-schema").Type<boolean>;
    ...
    operation: import("@kbn/config-schema").Type<"histogram">;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_23 extends keyof T ? { [P_1 in T_23]: T[P_1]; } : never)]: T[K]; } extends infer T_22 extends Props ? { [Key_6 in keyof T_22]: undefined extends TypeOf<T_22[Key_6]> ? never : Key_6; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"field", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"include_empty_rows", keyof T> | Exclude<"granularity", keyof T>] extends infer T_21 extends keyof (Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    field: import("@kbn/config-schema").Type<string>;
    granularity: import("@kbn/config-schema").Type<number | "auto">;
    include_empty_rows: import("@kbn/config-schema").Type<boolean>;
...
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_27 extends keyof T ? { [P_1 in T_27]: T[P_1]; } : never)]: T[K]; } extends infer T_26 extends Props ? { [Key_7 in keyof T_26]: undefined extends TypeOf<T_26[Key_7]> ? Key_7 : never; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"field", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"ranges", keyof T>] extends infer T_25 extends keyof (Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    field: import("@kbn/config-schema").Type<string>;
    ranges: import("@kbn/config-schema").Type<Readonly<{
        lte?: number | undefined;
    ...
    operation: import("@kbn/config-schema").Type<"range">;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_31 extends keyof T ? { [P_1 in T_31]: T[P_1]; } : never)]: T[K]; } extends infer T_30 extends Props ? { [Key_8 in keyof T_30]: undefined extends TypeOf<T_30[Key_8]> ? never : Key_8; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"field", keyof T> | Exclude<"format", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T> | Exclude<"ranges", keyof T>] extends infer T_29 extends keyof (Omit<{
    label: import("@kbn/config-schema").Type<string | undefined>;
    field: import("@kbn/config-schema").Type<string>;
    ranges: import("@kbn/config-schema").Type<Readonly<{
        lte?: number | undefined;
...
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_35 extends keyof T ? { [P_1 in T_35]: T[P_1]; } : never)]: T[K]; } extends infer T_34 extends Props ? { [Key_9 in keyof T_34]: undefined extends TypeOf<T_34[Key_9]> ? Key_9 : never; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filters", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T>] extends infer T_33 extends keyof (Omit<{
    filters: import("@kbn/config-schema").Type<Readonly<{
        label?: string | undefined;
    } & {
        filter: Readonly<{} & {
    ...
    label: import("@kbn/config-schema").Type<string | undefined>;
    operation: import("@kbn/config-schema").Type<"filters">;
}, keyof T> & { [K in keyof ({ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] extends infer T_39 extends keyof T ? { [P_1 in T_39]: T[P_1]; } : never)]: T[K]; } extends infer T_38 extends Props ? { [Key_10 in keyof T_38]: undefined extends TypeOf<T_38[Key_10]> ? never : Key_10; } : never)[{ [Key_1 in keyof T]: undefined extends T[Key_1] ? never : null extends T[Key_1] ? never : Key_1; }[keyof T] | Exclude<"filters", keyof T> | Exclude<"operation", keyof T> | Exclude<"label", keyof T>] extends infer T_37 extends keyof (Omit<{
    filters: import("@kbn/config-schema").Type<Readonly<{
        label?: string | undefined;
    } & {
        filter: Readonly<{} & {
