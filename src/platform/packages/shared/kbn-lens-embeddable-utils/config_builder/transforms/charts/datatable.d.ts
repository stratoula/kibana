...
export declare function fromAPItoLensState(config: DatatableState): DatatableAttributesWithoutFiltersAndQuery;
export declare function fromLensStateToAPI(config: LensAttributes): DatatableState;
export {};
