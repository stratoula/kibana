...
import type { LensApiAllOperations, LensApiState } from '../schema';
...
export declare function isTextBasedLayer(layer: LensApiState | DataSourceStateLayer): layer is TextBasedLayer;
 ...
 *
 */
export declare const buildDatasourceStates: (config: LensApiState, buildDataLayers: (config: unknown, i: number, index: {
    index: string;
    timeFieldName: string | undefined;
...
export declare const filtersAndQueryToLensState: (state: LensApiState, references: SavedObjectReference[]) => {
    query?: Query | {
        esql: string;
    } | undefined;
