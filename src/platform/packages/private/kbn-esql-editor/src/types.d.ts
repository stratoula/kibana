...
export interface ESQLEditorProps {
    ...
    onTextLangQuerySubmit: (query?: AggregateQuery, abortController?: AbortController) => Promise<void>;
    /** Array of errors */
    errors?: Error[];
...
export declare enum HistoryTabId {
    recentQueries = "history-queries-tab",
    standardQueries = "starred-queries-tab"
}
export type EsqlLanguageDeps = ESQLCallbacks & Partial<{
