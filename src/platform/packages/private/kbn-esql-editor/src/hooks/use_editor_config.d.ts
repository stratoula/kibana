...
export declare const useEditorConfig: ({ editorRef, editorModel, editorModelUriRef, editorCommandDisposables, esqlCallbacks, telemetryCallbacks, isDisabled, measuredEditorWidth, setMeasuredEditorWidth, resetPendingTracking, }: UseEditorConfigParams) => {
