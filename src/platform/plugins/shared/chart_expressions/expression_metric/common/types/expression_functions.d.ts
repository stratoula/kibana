...
import type { LayoutDirection, MetricStyle, MetricWTrend, SecondaryMetricProps } from '@elastic/charts';
import type { $Values } from '@kbn/utility-types';
import type { Datatable, DefaultInspectorAdapters, ExecutionContext, ExpressionFunctionDefinition, ExpressionValueRender } from '@kbn/expressions-plugin/common';
import type { AllowedChartOverrides, AllowedSettingsOverrides, CustomPaletteState } from '@kbn/charts-plugin/common';
...
import type { EXPRESSION_METRIC_NAME, EXPRESSION_METRIC_TRENDLINE_NAME, AvailableMetricIcons } from '../constants';
...
export type TrendlineExpressionFunctionDefinition = ExpressionFunctionDefinition<typeof EXPRESSION_METRIC_TRENDLINE_NAME, Datatable, TrendlineArguments, TrendlineResult>;
