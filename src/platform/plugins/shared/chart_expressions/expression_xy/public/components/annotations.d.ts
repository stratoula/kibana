...
export declare const getAnnotationsGroupedByInterval: (annotations: PointEventAnnotationRow[], configs: EventAnnotationOutput[] | undefined, columns: DatatableColumn[] | undefined, formatFactory: FormatFactory, timeFormat: string) => MergedAnnotation[];
