...
type PartialMergedAnnotation = Pick<MergedAnnotation, 'position' | 'icon' | 'textVisibility' | 'label' | 'isGrouped'>;
...
export declare function mapVerticalToHorizontalPlacement(placement: Position): "top" | "bottom" | "left" | "right";
export declare function MarkerBody({ label, isHorizontal, }: {
    label: string | undefined;
    isHorizontal: boolean;
}): React.JSX.Element | null;
export declare const AnnotationIcon: ({ type, rotateClassName, isHorizontal, renderedInChart, ...rest }: {
    type: string;
