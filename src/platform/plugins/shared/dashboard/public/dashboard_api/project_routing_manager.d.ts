...
export declare function initializeProjectRoutingManager(initialState: DashboardState, projectRoutingRestore$: PublishingSubject<boolean>): {
    ...
    internalApi: {
        startComparing: (lastSavedState$: BehaviorSubject<DashboardState>) => import("rxjs").Observable<Partial<Pick<import("@kbn/utility-types").Writable<Readonly<{
            query?: Readonly<{} & {
                language: "kql" | "lucene";
                expression: string;
            }> | undefined;
        ...
        comparators: StateComparators<Pick<import("@kbn/utility-types").Writable<Readonly<{
            query?: Readonly<{} & {
                language: "kql" | "lucene";
                expression: string;
            }> | undefined;
        ...
        getState: () => Pick<DashboardState, "project_routing">;
