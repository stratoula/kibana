...
interface DashboardSaveModalProps {
    onSave: ({ newTitle, newDescription, newCopyOnSave, newTags, newTimeRestore, newProjectRoutingRestore, isTitleDuplicateConfirmed, newAccessMode, onTitleDuplicate, }: DashboardSaveOptions) => Promise<SaveResult>;
    onClose: () => void;
    title: string;
    description: string;
    tags?: string[];
