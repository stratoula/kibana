...
import type { CanExpandPanels, CanPinPanels, HasLastSavedChildState, HasSections, HasSerializedChildState, PassThroughContext, PresentationContainer, PublishesSettings, TrackContentfulRender, EmbeddableAppContext, HasAppContext, HasExecutionContext, HasType, HasUniqueId, PublishesDataLoading, PublishesDataViews, PublishesDescription, PublishesEditablePauseFetch, PublishesHideBorder, PublishesSavedObjectId, PublishesTitle, PublishesUnifiedSearch, PublishesProjectRouting, PublishesViewMode, PublishesWritableViewMode, PublishingSubject, ViewMode, PublishesSearchSession, PublishesReload } from '@kbn/presentation-publishing';
...
export declare const DASHBOARD_API_TYPE = "dashboard";
/**
...
export declare const ReservedLayoutItemTypes: readonly string[];
export type DashboardInitializationState = Partial<DashboardState & {
...
export interface DashboardCreationOptions {
    ...
    searchSessionSettings?: {
        ...
        createSessionRestorationDataProvider: (dashboardApi: DashboardApi, dashboardInternalApi: DashboardInternalApi) => SearchSessionInfoProvider;
    };
 ...
 */
export type DashboardApi = CanExpandPanels & CanPinPanels & HasSections & HasAppContext & HasExecutionContext & HasLastSavedChildState & HasSerializedChildState & HasType<typeof DASHBOARD_API_TYPE> & HasUniqueId & PassThroughContext & PresentationContainer & PublishesDataLoading & PublishesDataViews & PublishesDescription & PublishesHideBorder & Pick<PublishesTitle, 'title$' | 'hideTitle$'> & PublishesReload & PublishesSavedObjectId & PublishesESQLVariables & PublishesSearchSession & PublishesSettings & PublishesUnifiedSearch & PublishesProjectRouting & PublishesViewMode & PublishesWritableViewMode & PublishesEditablePauseFetch & TrackContentfulRender & TracksOverlays & PublishesOnSave & {
