...
import type { DashboardCreateRequestBody, DashboardSearchRequestParams, DashboardUpdateRequestBody } from '../../server';
...
export declare const dashboardClient: {
    create: (dashboardState: DashboardCreateRequestBody, accessMode?: SavedObjectAccessControl["accessMode"]) => Promise<Readonly<{} & {
        id: string;
        data: Readonly<{
            query?: Readonly<{} & {
                language: "kql" | "lucene";
    ...
    search: (searchParams: DashboardSearchRequestParams) => Promise<Readonly<{} & {
        page: number;
        total: number;
        dashboards: Readonly<{} & {
            id: string;
    ...
    update: (id: string, dashboardState: DashboardUpdateRequestBody) => Promise<Readonly<{} & {
        id: string;
        data: Readonly<{
            query?: Readonly<{} & {
                language: "kql" | "lucene";
