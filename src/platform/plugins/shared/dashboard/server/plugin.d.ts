...
import type { PluginInitializerContext, CoreSetup, CoreStart, Plugin, RequestHandlerContext } from '@kbn/core/server';
...
export declare class DashboardPlugin implements Plugin<DashboardPluginSetup, DashboardPluginStart, SetupDeps, StartDeps> {
    private readonly logger;
    private apiUsageCounter?;
    constructor(initializerContext: PluginInitializerContext);
    setup(core: CoreSetup<StartDeps, DashboardPluginStart>, plugins: SetupDeps): {};
    start(core: CoreStart, plugins: StartDeps): {
        scanDashboards: typeof scanDashboards;
        client: {
            read: (requestCtx: RequestHandlerContext, id: string) => Promise<Readonly<{
                warnings?: Readonly<{
