export declare function getSanitizeRequestBodySchema(): import("@kbn/config-schema").ObjectType<{
...
export declare function getSanitizeResponseBodySchema(): import("@kbn/config-schema").ObjectType<{
