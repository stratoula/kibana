...
import type { ErrorsByTraceId, FocusedTraceWaterfallProps, FullTraceWaterfallProps, SpanLinks, TraceRootSpan, UnifiedSpanDocument } from '@kbn/apm-types';
...
export interface SecuritySolutionCellRendererFeature {
    ...
    getRenderer: () => Promise<(fieldName: string) => FunctionComponent<DataGridCellValueElementProps> | undefined>;
}
...
export type SecuritySolutionFeature = SecuritySolutionCellRendererFeature | SecuritySolutionAlertFlyoutOverviewTabFeature | SecuritySolutionAlertFlyoutHeaderTitleFeature | SecuritySolutionAlertFlyoutFooterFeature;
/** ****************************************************************************************/
...
export interface ObservabilityTracesFetchSpanFeature {
    ...
    }, signal: AbortSignal) => Promise<UnifiedSpanDocument | undefined>;
}
export interface ObservabilityTracesFetchLatencyOverallTransactionDistributionFeature {
    ...
    fetchLatencyOverallTransactionDistribution: (params: {
...
export interface ObservabilityTracesFetchLatencyOverallSpanDistributionFeature {
    ...
    fetchLatencyOverallSpanDistribution: (params: {
        spanName: string;
        serviceName: string;
        start: string;
        end: string;
...
export type ObservabilityTracesFeature = ObservabilityTracesSpanLinksFeature | ObservabilityTracesFetchErrorsFeature | ObservabilityTracesFetchRootSpanByTraceIdFeature | ObservabilityTracesFetchSpanFeature | ObservabilityTracesFetchLatencyOverallTransactionDistributionFeature | ObservabilityTracesFetchLatencyOverallSpanDistributionFeature | ObservabilityFocusedTraceWaterfallFeature | ObservabilityFullTraceWaterfallFeature;
/** ****************************************************************************************/
export type DiscoverFeature = ObservabilityStreamsFeature | ObservabilityLogsAIAssistantFeature | ObservabilityLogsAIInsightFeature | ObservabilityCreateSLOFeature | ObservabilityLogEventsFeature | ObservabilityTracesFeature | ObservabilityLogsFetchDocumentByIdFeature | SecuritySolutionFeature;
/**
 * Service types
 */
