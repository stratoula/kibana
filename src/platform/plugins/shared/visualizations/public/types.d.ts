...
import type { IAggConfigs, SerializedSearchSourceFields, TimefilterContract, AggConfigSerialized } from '@kbn/data-plugin/public';
...
export type VisToExpressionAst<TVisParams extends VisParams = VisParams> = (vis: Vis<TVisParams>, params: VisToExpressionAstParams) => Promise<ExpressionAstExpression> | ExpressionAstExpression;
