...
export declare function saveVisualization(savedObject: ISavedVis & Pick<VisSavedObject, 'displayName' | 'lastSavedTitle' | 'searchSource' | 'tags' | 'version'>, { confirmOverwrite, isTitleDuplicateConfirmed, onTitleDuplicate, copyOnSave, }: SaveVisOptions, services: StartServices & {
    savedObjectsTagging?: SavedObjectsTaggingApi;
