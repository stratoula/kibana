...
export declare const valueToComboBoxOption: (value: string) => import("@elastic/eui/src/components/combo_box/types").EuiComboBoxOptionOption<"boolean" | "date" | "keyword" | "long" | "geo_point" | "ip" | "double" | "composite"> | undefined;
