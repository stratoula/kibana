import type { RequestArgs, RequestResult } from '../../application/hooks/use_send_current_request/send_request';
...
export declare function hasComments(data: string): boolean;
...
export declare const replaceVariables: (requests: RequestArgs["requests"], variables: DevToolsVariable[]) => {
    url: string;
    method: string;
    data: string[];
    lineNumber?: number;
