...
export declare const DocViewerTable: React.ForwardRefExoticComponent<DocViewRenderProps & Pick<import("@kbn/restorable-state").RestorableStateProviderProps<DocViewerTableRestorableState>, "onInitialStateChange" | "initialState"> & React.RefAttributes<never>>;
