 ...
 */
export declare function UnifiedDocViewerFlyout({ docViewerRef, 'data-test-subj': dataTestSubj, flyoutTitle, flyoutDefaultWidth, flyoutActions, flyoutType, flyoutWidthLocalStorageKey, services, docViewsRegistry, isEsqlQuery, columns, columnsMeta, hit, hits, dataView, hideFilteringOnComputedColumns, initialTabId, initialDocViewerState, renderCustomHeader, renderCustomFooter, setExpandedDoc, onClose, onAddColumn, onRemoveColumn, onFilter, onInitialDocViewerStateChange, onUpdateSelectedTabId, }: UnifiedDocViewerFlyoutProps): React.JSX.Element;
