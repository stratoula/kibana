...
export declare class ProjectNavigationService {
    ...
    start(startDeps: StartDeps): {
        ...
        getNavigation$: () => Observable<{
            solutionId: "security" | "workplaceai" | "oblt" | "es";
        ...
        getActiveSolutionNavId$: () => Observable<"security" | "workplaceai" | "oblt" | "es" | null>;
        getActiveSolutionNavId: () => "security" | "workplaceai" | "oblt" | "es" | null;
    };
    stop(): void;
}
export {};
