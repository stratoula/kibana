...
import type { ServiceStatusLevelId, StatusInfoServiceStatus as ServiceStatus } from '@kbn/core-status-common';
...
export declare function loadStatus({ http, notifications, }: {
    ...
    name: string;
    version: import("@kbn/core-status-common").ServerVersion;
